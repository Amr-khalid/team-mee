            ...
            <AnimatePresence mode="wait">
              {isPicking ? (
                ...
                <motion.div key="result" initial={{ opacity: 0, scale: 0.5, y: 20 }} animate={{ opacity: 1, scale: 1, y: 0 }} className="text-center">
                  <motion.div animate={{ y: [0, -10, 0] }} transition={{ duration: 3, repeat: Infinity }} className="w-24 h-24 bg-gradient-to-br from-purple-500 to-cyan-900 rounded-2xl mx-auto flex items-center justify-center mb-6 shadow-[0_0_40px_rgba(0,243,255,0.4)] rotate-12">
